 ...
 */
final class Version20220429210623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD dtype VARCHAR(255) NOT NULL, ADD cin INT DEFAULT NULL, ADD domaine VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE candidat_reponse DROP FOREIGN KEY FK_6BB282D8D0EB82');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP dtype, DROP cin, DROP domaine');
    }
}
